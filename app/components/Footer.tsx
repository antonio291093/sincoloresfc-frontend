...
export default function Footer() {
  return (
    <footer className="bg-neutral-900 mt-auto py-10 text-neutral-400">
      <div className="max-w-6xl mx-auto flex flex-col items-center gap-6 px-4">
        ...
        <div className="flex items-center gap-4">
          <a
            href="https://x.com/sincoloresfc"
            target="_blank"
            rel="noopener noreferrer"
            aria-label="SinColoresFC en X (Twitter)"
          ...
          <a
            href="https://instagram.com/sincoloresfc"
            target="_blank"
            rel="noopener noreferrer"
            aria-label="SinColoresFC en Instagram"
            className="text-neutral-400 hover:text-white transition-colors"
          >
            {/* Instagram icon */}
            <svg className="w-5 h-5" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
        ...
        {/* Nota legal */}
        <p className="text-xs text-neutral-500 text-center max-w-xl leading-relaxed">
        ...
        <p className="text-xs text-neutral-600">
          &copy; {new Date().getFullYear()} SinColoresFC.mx. Todos los derechos
          reservados.
        </p>
      </div>
    </footer>
